...
function(t, e) {
    ...
    t.MixItUp = function() {
        ...
        _init: function(e, i) {
            ...
            } else s.controls.enable && s._updateControls({
                filter: s._activeFilter,
                sort: s._activeSort
            });
        ...
        _compare: function(t, e, i) {
            i = i ? i : 0;
            var s = this,
                n = s._newSort[i].order,
                o = function(t) {
                    return t.dataset[s._newSort[i].sortBy] || 0
                },
                r = isNaN(1 * o(t)) ? o(t).toLowerCase() : 1 * o(t),
        ...
        _printSort: function(t) {
            var e = this,
                ...
                s = e._$parent[0].querySelectorAll(e.selectors.target),
                n = s.length ? s[s.length - 1].nextElementSibling : null,
            ...
            for (var r = 0; r < i.length; r++) {
                var h = i[r];
                if ("default" !== e._newSort[0].sortBy || "desc" !== e._newSort[0].order || t) o.appendChild(h), o.appendChild(document.createTextNode(" "));
                else {
                    var c = o.firstChild;
                ...
                i = function(e, i, s) {
                    if (t.animation.effects.indexOf(e) > -1) {
                        if (i) {
                            ...
                            if (n > -1) {
                                var o = t.animation.effects.substring(n),
                                    r = /\(([^)]+)\)/.exec(o),
                                    a = r[1];
                                return {
                                    val: a
        ...
        _animateTargets: function() {
            ...
            for (var i = 0; i < e._$toShow.length; i++) {
                var s = e._$toShow[i],
                    n = t(s),
                    o = {
                        x: s.dataset.finalPosX - s.dataset.interPosX,
                        y: s.dataset.finalPosY - s.dataset.interPosY
                    },
                    r = e._getDelay(i),
                    a = {};
                s.style.opacity = "";
        ...
        _execAction: function(t, e, i) {
            var s = this,
                n = e ? "post" : "pre";
            if (!s._actions.isEmptyObject && s._actions.hasOwnProperty(t))
                for (var o in s._actions[t][n]) s._actions[t][n][o].call(s, i)
        },
        ...
        getOption: function(t) {
            var i = this,
                s = function(t, i) {
                    for (var s = i.split("."), n = s.pop(), o = s.length, r = 1, a = s[0] || i;
                        (t = t[a]) && o > r;) a = s[r], r++;
        ...
        return s = s ? s : "", this.each(function() {
            for (var n = this, o = i.split(" "), r = 0; r < o.length; r++)
                for (var a = 0; 4 > a; a++) {
                    switch (a) {
                        case 0:
                            var l = o[r];
...
function(t, e) {
    ...
    var t = function(t, e) {
        ...
        i = function(t, e) {
            ...
            if (Array.prototype.map && t.map === Array.prototype.map) n = Array.prototype.map.call(t, function(t) {
                ...
                for (i = 0; o > i; i++) callback_params = s, callback_params.splice(0, 0, t[i]), n.push(e.apply(this, callback_params));
            return n
        },
        s = function(t) {
            var e, i = [];
        ...
        l = function(e) {
            ...
            var i = document,
                s = function(e) {
                    ...
                    var S = function(t, e) {
                        var i = "",
                            s = window.context_menu[o.el.id][t];
                        for (var n in s)
                            ...
                            h.innerHTML = i;
                            var n, c = h.getElementsByTagName("a"),
                                p = c.length;
                            for (n = 0; p > n; n++) {
                                var g = c[n],
                                    d = function(i) {
                    ...
                    this.buildContextMenu = function(t, e) {
                        ...
                        for (e in t.options)
                            if (t.options.hasOwnProperty(e)) {
                                var n = t.options[e];
                                window.context_menu[o.el.id][t.control][n.name] = {
                                    title: n.title,
                                    action: n.action
                                }
    ...
    l.prototype.createControl = function(t) {
        ...
        return e.setMap(this.map), null != t.auto_show && (i = t.auto_show), e.onAdd = function() {
            ...
            var s = this.getProjection(),
                n = s.fromLatLngToDivPixel(new google.maps.LatLng(t.lat, t.lng));
        ...
        if (i.length)
            if (void 0 === i[0][0]) e = i;
                ...
                for (var s, n = 0; s = i[n]; n++) e.push(new google.maps.LatLng(s[0], s[1]));
        var o = {
            map: this.map,
            path: e,
        ...
        var n = !1;
        e.hasOwnProperty("useGeoJSON") && (n = e.useGeoJSON), delete e.useGeoJSON, e = t({
            map: this.map
        }, e), 0 == n && (e.paths = [e.paths.slice(0)]), e.paths.length > 0 && e.paths[0].length > 0 && (e.paths = s(i(e.paths, o, n)));
        ...
        var s = t,
            n = new google.maps.KmlLayer(e, s);
    ...
    return l.prototype.getRoutes = function(e) {
        ...
        if (t.origin && t.destination) this.getRoutes({
            ...
            callback: function(e) {
                if (e.length > 0 && t.start && t.start(e[e.length - 1]), e.length > 0 && t.step) {
                    var i = e[e.length - 1];
                    if (i.legs.length > 0)
                        for (var s, n = i.legs[0].steps, o = 0; s = n[o]; o++) s.step_number = o, t.step(s, i.legs[0].steps.length - 1)
                }
                e.length > 0 && t.end && t.end(e[e.length - 1])
            }
        });
        else if (t.route && t.route.legs.length > 0)
            for (var e, i = t.route.legs[0].steps, s = 0; e = i[s]; s++) e.step_number = s, t.step(e)
        ...
        if (t.origin && t.destination) this.getRoutes({
            ...
            callback: function(i) {
                if (i.length > 0 && t.start && t.start(i[i.length - 1]), i.length > 0 && t.step) {
                    var s = i[i.length - 1];
                    if (s.legs.length > 0)
                        for (var n, o = s.legs[0].steps, r = 0; n = o[r]; r++) {
                            n.step_number = r;
                            var a = {
                                path: n.path,
                                strokeColor: t.strokeColor,
            ...
            for (var i, s = t.route.legs[0].steps, n = 0; i = s[n]; n++) {
                i.step_number = n;
                var o = {
                    path: i.path,
                    strokeColor: t.strokeColor,
        ...
        delete t.styles;
        var a = t.polyline;
        if (delete t.polyline, t.center) s.push("center=" + t.center), delete t.center;
        else if (t.address) s.push("center=" + t.address), delete t.address;
        else if (t.lat) s.push(["center=", t.lat, ",", t.lng].join("")), delete t.lat, delete t.lng;
        else if (t.visible) {
        ...
        if (r)
            for (var u = 0; u < r.length; u++) {
                ...
                for (var m = 0; m < r[u].stylers.length; m++)
                    for (var _ in r[u].stylers[m]) {
        ...
        if (a) {
            ...
            var b = i.path;
            if (b.join)
                for (var C, m = 0; C = b[m]; m++) a.push(C.join(","));
            else a.push("enc:" + b);
        ...
        for (var s = ["closeclick", "links_changed", "pano_changed", "position_changed", "pov_changed", "resize", "visible_changed"], n = t({
                visible: !0
            }, e), o = 0; o < s.length; o++) delete n[s[o]];
        ...
        if (-1 == l.custom_events.indexOf(t)) google.maps.event.trigger(e, t, Array.prototype.slice.apply(arguments).slice(2));
            ...
            for (var s = i.registered_events[t], n = 0; n < s.length; n++) ! function(t, e, i) {
                t.apply(e, [i])
            }(s[n].handler, i, e)
        ...
        for (var i = !1, s = this.getPaths().getLength(), n = 0; s > n; n++)
            for (var o = this.getPaths().getAt(n), r = o.getLength(), a = r - 1, l = 0; r > l; l++) {
                var h = o.getAt(l),
                    c = o.getAt(a);
